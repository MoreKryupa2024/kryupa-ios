    ...
    var body: some View {
        HStack {
            ...
            VStack(alignment: .leading) {
                ...
                Text("\(jobPostData.bookingDetails.startDate.convertDateFormater(beforeFormat: "yyyy-MM-dd", afterFormat: "MMMM d")) - \(jobPostData.bookingDetails.endDate.convertDateFormater(beforeFormat: "yyyy-MM-dd", afterFormat: "MMMM d yyyy"))")
